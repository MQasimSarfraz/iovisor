...
#
#eBPF program http_filter is used as SOCKET_FILTER attached to docker0 interface.
...
#create raw socket, bind it to docker0
#attach bpf program to socket created
BPF.attach_raw_socket(function_http_filter, "docker0")
...
#attach kprobe for sys_clone system call
bpf.attach_kprobe(event="sys_open", fn_name="sys_call_count")
...
#get pointer for bpf map of type array
bpf_stats = bpf.get_table("stats")
